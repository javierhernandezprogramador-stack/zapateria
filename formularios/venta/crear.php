<h2 class="formulario__titulo" id="t-venta"></h2>
<form method="post" class="formulario formulario-registro">
    <input type="hidden" id="idVenta">
    <div class="campos">
        <div class="campos-column">
            <label for="clientes">Clientes</label>
            <select name="clientes" id="clientes" class="campo__input campo__input-select">
            </select>
        </div>
        <div class="campos-column">
    ...
    <div class="botones__formulario-registrar contenedor">
        ...
        <input type="button" class="boton boton-agregar btn-compra" id="btnGuardar-venta">
    </div>
</form>