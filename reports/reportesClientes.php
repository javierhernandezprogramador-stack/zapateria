...
class PDF extends FPDF {
    ...
    private $title = "Cantidad de Compras por Clientes";
...
include "../models/DaoCliente.php"; // Asegúrate de que esta clase existe
require_once __DIR__ . '/../route.php'; //manejador de la url base

$dao = new DaoCliente(); // Instancia de la clase DaoProveedor
...
$pdf->AddPage();
$pdf->DocumentTitle();
$pdf->PremiumTable($dao->consultaClientesVentas()); // Llamada al método para obtener los datos
$pdf->Output();
?>
