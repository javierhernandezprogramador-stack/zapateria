...
class PDF extends FPDF {
    ...
    private $title = "Listado de Productos Mas a Menos Vendidos";
    ...
    function PremiumTable($data) {
        ...
        foreach ($data as $row) {
            ...
            $this->Cell($widths[1], 10, utf8_decode($row['producto']), "LR", 0, "L", $fill); // Nombre
...
$pdf->AddPage();
$pdf->DocumentTitle();
$pdf->PremiumTable($dao->listarProductosVendidos()); // Llamada al método para obtener los datos
$pdf->Output();
?>
