...
function validarOperacion($operacion, $obj, $id)
{
    ...
    require_once ROOT_PATH . '/models/DaoCliente.php';
    require_once ROOT_PATH . '/utils/cliente/consultasCliente.php';
    require_once ROOT_PATH . '/utils/validar.php';
    ...
    switch ($operacion) {
        case 'registrar':
            echo json_encode($dao->save($obj->cliente));
            break;
        case 'modificar':
            echo json_encode($dao->update($obj->cliente, $id));
            break;
        case 'eliminar':
        ...
        case 'seleccionar':
            ...
            break;
        case 'dashboard':
            echo json_encode($dao->cantidadRegistros());
            break;
        case 'listarTodos':
